...
describe('BaseFirestoreRepository', function () {
    ...
    describe('constructor', function () {
        it('should correctly initialize a repository with custom path', function () { return __awaiter(void 0, void 0, void 0, function () {
            var bandRepositoryWithPath, band;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bandRepositoryWithPath = new BandRepository('bands');
                        return [4 /*yield*/, bandRepositoryWithPath.findById('porcupine-tree')];
                    case 1:
                        band = _a.sent();
        ...
        it('should correctly initialize a repository with an entity', function () { return __awaiter(void 0, void 0, void 0, function () {
            var bandRepositoryWithPath, band;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bandRepositoryWithPath = new BandRepository(BandCollection_1.Band);
                        return [4 /*yield*/, bandRepositoryWithPath.findById('porcupine-tree')];
                    case 1:
                        band = _a.sent();
                        expect(band.name).toEqual('Porcupine Tree');
        ...
        it('should throw error if initialized with an invalid path', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(function () { return new BandRepository('invalidpath'); }).toThrowError(new Errors_1.NoMetadataError('invalidpath'));
                return [2 /*return*/];
            });
        }); });
    });
        ...
        it('must limit subcollections', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        pt = _a.sent();
                        return [4 /*yield*/, pt.albums.limit(2).find()];
                    case 2:
                        albums = _a.sent();
    ...
    describe('create', function () {
        ...
        it('must validate forbidden non-whitelisted properties if the validatorOptions: { whitelist: true, forbidNonWhitelisted: true }', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        expect(error_1[0].constraints.whitelistValidation).toEqual('property custom should not exist');
                        return [3 /*break*/, 4];
        ...
        it('throw error when trying to create objects with duplicated id', function () { return __awaiter(void 0, void 0, void 0, function () {
            var entity;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(bandRepository.create(entity)).rejects.toThrowError('A document with id pink-floyd already exists.')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('must fail validation if an invalid object is given', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_5 = _a.sent();
                        expect(error_5[0].constraints.isEmail).toEqual('Invalid email!');
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    describe('.where*', function () {
        ...
        it('must filter with whereNotEqualTo', function () { return __awaiter(void 0, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bandRepository.whereNotEqualTo('name', 'Porcupine Tree').find()];
                    case 1:
                        list = _a.sent();
                        expect(list.length).toEqual(1);
        ...
        it('must filter with whereNotIn', function () { return __awaiter(void 0, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bandRepository.whereNotIn('formationYear', [1965]).find()];
                    case 1:
                        list = _a.sent();
                        expect(list.length).toEqual(2);
                        return [2 /*return*/];
        ...
        it('should throw with whereNotIn and more than 10 items in val array', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
    ...
    describe('miscellaneous', function () {
        ...
        it('should correctly filter by null values', function () { return __awaiter(void 0, void 0, void 0, function () {
            var entity, bandsWithNullFormationYear;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        entity = new BandCollection_1.Band();
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bandRepository
                                .whereEqualTo(function (a) { return a.formationYear; }, null)
                                .findOne()];
                    case 2:
                        bandsWithNullFormationYear = _a.sent();
    ...
    describe('transactions', function () {
        ...
        it('runTransaction should return TransactionRepository', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bandRepository.runTransaction(function (tran) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
    ...
    describe('must handle subcollections', function () {
        ...
        it('should be able to validate subcollections on update', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_7 = _a.sent();
                        expect(error_7[0].constraints.length).toEqual('Name is too long');
                        return [3 /*break*/, 6];
        ...
        it('should be able to update subcollections of subcollections', function () { return __awaiter(void 0, void 0, void 0, function () {
            var band, firstAlbum, album, image1, image2, images, foundBand, foundAlbums, foundImages;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        band = new BandCollection_1.Band();
