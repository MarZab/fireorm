...
exports.getBandFixture = function () {
    ...
    var objectifyList = function (arr, cb) {
        return arr.reduce(function (acc, cur) {
            var _a;
            return (__assign(__assign({}, acc), (_a = {}, _a[cur.id] = cb ? cb(cur) : cur, _a)));
        }, {});
    };
    return objectifyList(initialData, function (_a) {
        var albums = _a.albums, rest = __rest(_a, ["albums"]);
        return (__assign(__assign({}, rest), getCollectionBoilerplate('albums', objectifyList(albums, function (_a) {
            var images = _a.images, album = __rest(_a, ["images"]);
            return (__assign(__assign({}, album), getCollectionBoilerplate('images', objectifyList(images))));
        }))));
    });
};
