import { Album as AlbumEntity, AlbumImage as AlbumImageEntity, Coordinates, FirestoreDocumentReference } from './fixture';
import { ISubCollection } from '../src/types';
declare class AlbumImage extends AlbumImageEntity {
}
export declare class Album extends AlbumEntity {
    name: string;
